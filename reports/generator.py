...
class SecurityReportGenerator:
    ...
    def _cover(self, pdf: GedrPDF, m: ReportModel) -> None:
        ...
        pdf.set_xy(96, 24.0)
        pdf.cell(98, 4.0, m.meta.classification.upper(), align="R")
        ...
        pdf.set_xy(16, y)
        pdf.cell(178, 13, m.meta.report_type)
        pdf.sans("B", 13)
        pdf.set_text_color(*STEEL)
        pdf.set_xy(16, y + 14.5)
        ...
        mini_tiles(pdf, 16, pdf.get_y() + 2, tile_w, 17.5, tiles)
