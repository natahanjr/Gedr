        ...
        for i, f in enumerate(ordered, start=1):
            ...
            if raw_rec:
                self.recommendations[fm.uid] = RecommendationModel(
                    explanation=clean(raw_rec.get("explanation"), max_length=2500),
                    impact=clean(raw_rec.get("impact"), max_length=2000),
                    attack_scenario=clean(raw_rec.get("attack_scenario"), max_length=2000),
                    root_cause=clean(raw_rec.get("root_cause"), max_length=2000),
                    recommended_fix=clean(raw_rec.get("recommended_fix"), max_length=2500),
